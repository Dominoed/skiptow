    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          const SizedBox(height: 8),
          Text(
            'Pricing: SkipTow collects a 10% platform fee from each service payment. Optional SkipTow Pro accounts are \$10 per month.',
            textAlign: TextAlign.center,
            style: Theme.of(context).textTheme.bodySmall,
          ),
          const SizedBox(height: 8),
          Text(
            'Refund policy: open a support chat in the app or website while logged in to request a refund.',
            textAlign: TextAlign.center,
            style: Theme.of(context).textTheme.bodySmall,
          ),
          const SizedBox(height: 8),
          Text(
            'Contact: skiptowhelp@gmail.com or start a support chat within the app.',
            textAlign: TextAlign.center,
            style: Theme.of(context).textTheme.bodySmall,
          ),
        ],
